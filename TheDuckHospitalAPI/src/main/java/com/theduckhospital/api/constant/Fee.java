...
public class Fee {
    public static final double HOSPITAL_ADMISSION_FEE = 1000000;
    public static final double STANDARD_ROOM_FEE = 100000;
    public static final double VIP_ROOM_FEE = 550000;
