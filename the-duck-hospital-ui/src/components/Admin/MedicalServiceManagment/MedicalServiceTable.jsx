                ...
                >
                  <Stack direction={"column"}>
                    <Button
                      ...
                      onClick={(e) => {
                        navigate(`/admin/service-management/${row.serviceId}`);
                      }}
                    >
                      Xem
                    </Button>
...
function MedicalServiceTable(props) {
            ...
            >
              <TableRow>
                <TableCell style={{ width: "30%" }}>
                  <CustomText color={"#101828"} style={{ fontWeight: "500" }}>Tên dịch vụ</CustomText>
                </TableCell>
