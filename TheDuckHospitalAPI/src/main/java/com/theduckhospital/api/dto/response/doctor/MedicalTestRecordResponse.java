...
@Data
public class MedicalTestRecordResponse {
    ...
    public MedicalTestRecordResponse(MedicalExaminationRecord examinationRecord, MedicalTest medicalTest) {
        ...
        this.patientPhoneNumber = examinationRecord.getPatientProfile().getPhoneNumber();
    }
}
